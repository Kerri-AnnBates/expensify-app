...
export const ExpenseSummary = ({ expenseCount, expensesTotal, allExpensesCount }) => (
	<div className="page-header">
		<div className="content-container">
			...
			<p className="page-header__subtitle">{(expenseCount === allExpensesCount) ?
				`Showing all expenses, no filters in place` :
				`Not showing ${allExpensesCount - expenseCount} expense(s) because of filters. Remove date filters to see all expenses`}</p>
